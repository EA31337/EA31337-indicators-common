...
/**
 * @file
 * Implements Volume Rate of Change (VROC) indicator.
 */

// Defines.
#define INDI_FULL_NAME "Volume Rate of Change"
#define INDI_SHORT_NAME "VROC"
...
// Resource files.
#ifdef __MQL5__
#property tester_indicator "::Indicators\\Examples\\VROC.ex5"
#resource "\\Indicators\\Examples\\VROC.ex5"
#endif

// Includes.
#include <EA31337-classes/Indicators/Indi_VROC.mqh>

// Input parameters.
input int InpVROCPeriod = 25;                               // Period
input ENUM_APPLIED_VOLUME InpVolumeType_ = VOLUME_TICK;     // Volumes
input int InpShift = 0;                                     // Shift
input ENUM_IDATA_SOURCE_TYPE InpSourceType = IDATA_BUILTIN; // Source type

// Global indicator buffers.
double InpExtVROCBuffer[];
...
void OnInit() {
  ...
  PlotIndexSetInteger(0, PLOT_DRAW_BEGIN, InpVROCPeriod);
...
int OnCalculate(const int rates_total, const int prev_calculated,
  ...
  start =
      prev_calculated == 0 ? fmax(0, InpVROCPeriod - 1) : prev_calculated - 1;
  // Main calculations.
