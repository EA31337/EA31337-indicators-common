...
/**
 * @file
 * Implements Bears Power indicator.
 */

// Defines.
#define INDI_FULL_NAME "Bears Power"
#define INDI_SHORT_NAME "Bears"
...
// Resource files.
#ifdef __MQL5__
#property tester_indicator "::Indicators\\Examples\\Bears.ex5"
#resource "\\Indicators\\Examples\\Bears.ex5"
#endif
...
input ENUM_APPLIED_PRICE InpBearsAppliedPrice = PRICE_OPEN; // Applied price
...
int OnInit() {
  ...
  PlotIndexSetInteger(0, PLOT_DRAW_BEGIN, InpBearsPeriod);
...
int OnCalculate(const int rates_total, const int prev_calculated,
  ...
  int i, start;
  if (rates_total < fmax(0, InpBearsPeriod)) {
    return (0);
  }
  // Initialize calculations.
  start =
      prev_calculated == 0 ? fmax(0, InpBearsPeriod - 1) : prev_calculated - 1;
  // Main calculations.
