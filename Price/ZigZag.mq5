...
// Defines.
#define INDI_FULL_NAME "ZigZag"
#define INDI_SHORT_NAME "ZigZag"
...
// Resource files.
#ifdef __MQL5__
#property tester_indicator "::Indicators\\Examples\\ZigZag.ex5"
...
// Input parameters.
input int InpDepth_ = 12;                                   // Depth
input int InpDeviation_ = 5;                                // Deviation
input int InpBackstep_ = 3;                                 // Back Step
...
int OnInit() {
  ...
  string short_name =
      StringFormat("%s(%d, %d, %d)", indi.GetName(), ::InpDepth_,
                   ::InpDeviation_, ::InpBackstep_);
