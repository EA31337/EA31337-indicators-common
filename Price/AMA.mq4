...
#define INDICATOR_LEGACY_VERSION_ACQUIRE_BUFFER ACQUIRE_BUFFER1(InpExtAMABuffer)
#define INDICATOR_LEGACY_VERSION_RELEASE_BUFFER RELEASE_BUFFER1(InpExtAMABuffer)
