...
/**
 * @file
 * Implements Momentum (MOM) indicator.
 */

// Defines.
#define INDI_FULL_NAME "Momentum"
#define INDI_SHORT_NAME "MOM"
...
void OnInit() {
  ...
  IndiMomentumParams _indi_params(::InpPeriod, ::InpAppliedPrice, ::InpShift);
  indi = new Indi_Momentum(_indi_params, InpSourceType);
  // Name for labels.
