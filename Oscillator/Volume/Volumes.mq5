...
/**
 * @file
 * Implements Volumes indicator.
 */

// Defines.
#define INDI_FULL_NAME "Volumes"
#define INDI_SHORT_NAME "Volumes"
...
// Resource files.
#ifdef __MQL5__
#property tester_indicator "::Indicators\\Examples\\Volumes.ex5"
#resource "\\Indicators\\Examples\\Volumes.ex5"
#endif
...
void OnInit() {
  ...
  IndiVolumesParams _indi_params(::InpVolumeType_, ::InpShift);
  indi = new Indi_Volumes(_indi_params, InpSourceType);
  // Name for labels.
