...
/**
 * @file
 * Implements Relative Vigor Index (RVI) indicator.
 */

// Defines.
#define INDI_FULL_NAME "Relative Vigor Index"
#define INDI_SHORT_NAME "RVI"
...
// Resource files.
#ifdef __MQL5__
#property tester_indicator "::Indicators\\Examples\\RVI.ex5"
#resource "\\Indicators\\Examples\\RVI.ex5"
#endif
...
void OnInit() {
  ...
  PlotIndexSetInteger(0, PLOT_DRAW_BEGIN, InpRVIPeriod);
...
int OnCalculate(const int rates_total, const int prev_calculated,
  ...
  start = prev_calculated == 0 ? InpRVIPeriod - 1 : prev_calculated - 1;
  // Main calculations.
  for (i = start; i < rates_total && !IsStopped(); i++) {
    ...
    ExtRVIBuffer[i] = _entry[(int)LINE_MAIN];
