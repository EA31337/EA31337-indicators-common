...
/**
 * @file
 * Implements Detrended Price Oscillator (DPO) indicator.
 */

// Defines.
#define INDI_FULL_NAME "Detrended Price Oscillator"
#define INDI_SHORT_NAME "DPO"
...
// Resource files.
#ifdef __MQL5__
#property tester_indicator "::Indicators\\Examples\\DPO.ex5"
#resource "\\Indicators\\Examples\\DPO.ex5"
#endif
...
// Input parameters.
input int InpDPOPeriod = 14;                                // Period
input ENUM_APPLIED_PRICE InpDPOAppliedPrice = PRICE_OPEN;   // Applied price
...
int OnCalculate(const int rates_total, const int prev_calculated,
  ...
  int i, start;
  if (rates_total < fmax(0, InpDPOPeriod)) {
    return (0);
  }
  // Initialize calculations.
  start =
      prev_calculated == 0 ? fmax(0, InpDPOPeriod - 1) : prev_calculated - 1;
  // Main calculations.
